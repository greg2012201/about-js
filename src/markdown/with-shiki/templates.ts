...
export const headerTemplate = ({ lang, codeBlockId }: HeaderProps) => {
  ...
  return dedent`
  <div className="header flex items-center border-b-[1px] border-slate-500 px-6 py-1 text-neutral-400">
...
export const wrapperTemplate = ({
  ...
  return dedent`
  <div className="flex flex-col rounded-md border-[1px] border-slate-500 bg-[#0f111a] my-6">
