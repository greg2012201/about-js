...
function Card({ children, className }: Props) {
  return (
    <div
      className={twMerge(
        className,
        "relative z-50 h-full w-full overflow-hidden rounded-2xl border border-transparent bg-gradient-to-br from-indigo-800 to-pink-800/[0.2]  group-hover:border-slate-700",
      )}
    >
